...
export interface PaymentGroupSearchResult {
  /** Search results. */
  results?: SalaryGroupBaseInfo[];
  /** Search result metadata. */
  meta?: SearchResultMetaData;
}

/** Search results. */
export interface SalaryGroupBaseInfo {
  /**
   * Id of the payment list.
   * @format int32
   */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  bankstatements = {
     ...
     * @response `404` `void` Bank statement not found
     */
    allocateAllocationMetadata: (
      statementId: number,
      eventId: number,
      data: AllocationMetadata,
      params: RequestParams = {},
    ) =>
      this.request<InfoMessage, ErrorMessages | void>({
     ...
     * @secure
     * @response `204` `void` Metadata deleted successfully
     * @response `404` `ErrorMessages` Bank statement event payment not found
     */
    deleteAllocationMetadata: (statementId: number, eventId: number, params: RequestParams = {}) =>
      this.request<void, ErrorMessages>({
        path: `/bankstatements/${statementId}/events/${eventId}/metadata`,
        method: "DELETE",
        secure: true,
  ...
  businesspartners = {
    ...
    /**
     * @description Returns basic information from the person register for the currently logged in user. Includes eg. name, address and payment information.
     *
     * @tags Business partners
  ...
  invoices = {
    /**
     * @description Returns comments for the given invoice. Supported invoice types: TRAVEL_INVOICE, EXPENSE_INVOICE and PURCHASE_INVOICE.
     *
     * @tags Invoices
    ...
    /**
     * @description Add comment to an invoice identified by id. Supported invoice types: TRAVEL_INVOICE, EXPENSE_INVOICE and PURCHASE_INVOICE
     *
     * @tags Invoices
    ...
    /**
     * @description Returns users who can be tagged for the given invoice. Supported invoice types: TRAVEL_INVOICE, EXPENSE_INVOICE and PURCHASE_INVOICE
     *
     * @tags Invoices
    ...
    /**
     * @description Supports sales and sales order invoices in unfinshed state, and expense claim, purchase, purchase order and travel invoices in unfinished and received states. Note that modifying invoice tax, discount, currency, accounting or row information can cause the adjoined ledger receipt to be recreated with a new ID.
     *
     * @tags Invoices
     * @name UpdateInvoice
  ...
  payments = {
    ...
    searchSalaryPaymentGroups: (
      ...
      this.request<PaymentGroupSearchResult, ErrorMessages>({
  ...
  referencepayments = {
     ...
     */
    allocateAllocationMetadata1: (referencePaymentId: number, data: AllocationMetadata, params: RequestParams = {}) =>
      this.request<InfoMessage, ErrorMessages>({
     ...
     * @response `404` `ErrorMessages` Reference payment not found
     */
    deleteAllocationMetadata1: (referencePaymentId: number, params: RequestParams = {}) =>
      this.request<void, ErrorMessages>({
        path: `/referencepayments/${referencePaymentId}/metadata`,
        method: "DELETE",
        secure: true,
